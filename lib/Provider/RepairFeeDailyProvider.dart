...
class RepairFeeDailyProvider with ChangeNotifier {
  final ApiService _apiService = ApiService();

  List<RepairFeeDailyModel> _data = [];
  DateTime? _lastLoadedDate;
  String? _lastLoadedMonth; // Thêm dòng này
  bool _isLoading = false;

  List<RepairFeeDailyModel> get data => _data;
  bool get isLoading => _isLoading;
  RepairFeeDailyModel? selectedItem;
  ...
  Future<void> fetchRepairFee(String month) async {
    ...
    final result = await _apiService.fetchRepairFeeDaily(month);
    _data = result;
    _lastLoadedDate = now;
