...
class ApiService {
  ...
  Future<List<DetailsRFMovingAveModel>> fetchDetailsRFMovingAve({
    required monthFrom,
    required String div,
    required monthTo,
    String? macName,
    ...
    final uri = Uri.parse(
      '$baseUrl/details_data/RFMovingAve?divisions=$div&monthFrom=$monthFrom&monthTo=$monthTo&macName=$macName',
    );
    final response = await http.get(uri);
